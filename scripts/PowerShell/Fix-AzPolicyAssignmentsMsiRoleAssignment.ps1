<#
This script was found on https://automate.guru/fix-msi-role-assignment/
...
foreach ($assignmentRbacFix in $assignmentsForRbacFix) {
    ...
    if ($policyDefinition) {
        ...
        $policyDefinitions += $policySetDefinition.Properties.PolicyDefinitions | ForEach-Object { Get-AzPolicyDefinition -Id $_.PolicyDefinitionId }
    }
    ...
    Get-AzRoleAssignment -Scope $assignmentRbacFix.Properties.Scope | Where-Object -Property ObjectType -EQ 'Unknown' | ForEach-Object {
